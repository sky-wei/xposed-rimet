 ...
 */
public class RimetConfig4629 extends RimetConfig {
    ...
    public void loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "jfx,jfx");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "kfm,kfm");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "che");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "che$9");
