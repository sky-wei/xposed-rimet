 ...
 */
public class RimetConfig4716 extends RimetConfig {
    ...
    public RimetConfig loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "liy,liy");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "mge,mge");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "cyo");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "cyo$9");
