 ...
 */
public class RimetConfig4700 extends RimetConfig {
    ...
    public RimetConfig loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "kim,kim");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "lhz,lhz");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "csq");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "csq$9");
