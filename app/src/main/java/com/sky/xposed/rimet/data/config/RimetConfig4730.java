 ...
 */
public class RimetConfig4730 extends RimetConfig {
    ...
    public RimetConfig loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "mkb,mkb");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "nig,nig");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "ddl");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "ddl$9");
