 ...
 */
public class RimetConfig4711 extends RimetConfig {
    ...
    public RimetConfig loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "lcf,lcf");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "lzj,lzj");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "cxg");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "cxg$9");
