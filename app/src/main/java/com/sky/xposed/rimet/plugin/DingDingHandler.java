...
//import com.sky.xposed.rimet.plugin.DingDingPlugin;
...
//
//        mEnableLucky = mXConfigManager.getBoolean(XConstant.XFlag.ENABLE_LUCKY, true);
//        mEnableFastLucky = mXConfigManager.getBoolean(XConstant.XFlag.ENABLE_FAST_LUCKY, true);
//        mEnableRecall = mXConfigManager.getBoolean(XConstant.XFlag.ENABLE_RECALL, true);
//        mEnableLocation = mXConfigManager.getBoolean(XConstant.XFlag.ENABLE_LOCATION, false);
//    }
//
//    @Override
...
//
//        switch (flag) {
//            case XConstant.XFlag.ENABLE_LUCKY:
//                mEnableLucky = enable;
//                break;
//            case XConstant.XFlag.ENABLE_FAST_LUCKY:
//                mEnableFastLucky = enable;
//                break;
//            case XConstant.XFlag.ENABLE_RECALL:
//                mEnableRecall = enable;
//                break;
//            case XConstant.XFlag.ENABLE_LOCATION:
...
//                mXConfigManager.getString(XConstant.XFlag.LUCKY_DELAYED, ""));
//
//        // 获取红包
//        postDelayed(() -> {
//            try {
...
//                    .getString(XConstant.XFlag.LATITUDE, "");
//            String longitude = mXConfigManager
//                    .getString(XConstant.XFlag.LONGITUDE, "");
//
