 ...
 */
public class RimetConfig4725 extends RimetConfig {
    ...
    public RimetConfig loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "mgu,mgu");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "nex,nex");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "dcw");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "dcw$9");
