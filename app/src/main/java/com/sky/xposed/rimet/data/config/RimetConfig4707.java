 ...
 */
public class RimetConfig4707 extends RimetConfig {
    ...
    public RimetConfig loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "ktg,ktg");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "lsx,lsx");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "cuy");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "cuy$9");
