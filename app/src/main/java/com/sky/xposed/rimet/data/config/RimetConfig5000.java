 ...
 */
public class RimetConfig5000 extends RimetConfig {
    ...
    public RimetConfig loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "mrp,mrp");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "npu,npu");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "dfq");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "dfq$9");
