 ...
 */
public class RimetConfig4633 extends RimetConfig {
    ...
    public RimetConfig loadConfig() {
        ...
        add(M.classz.class_defpackage_MessageDs, "jjk,jjk");        // MessageDs
        add(M.classz.class_plugin_webwx_ui_ExtDeviceWXLoginUI, "com.tencent.mm.plugin.webwx.ui.ExtDeviceWXLoginUI");
        add(M.classz.class_defpackage_ServiceFactory, "kix,kix");   // ServiceFactory
        ...
        add(M.classz.class_defpackage_RedPacketsRpc, "chw");    // RedPacketsRpc
        add(M.classz.class_defpackage_RedPacketsRpc_9, "chw$9");
