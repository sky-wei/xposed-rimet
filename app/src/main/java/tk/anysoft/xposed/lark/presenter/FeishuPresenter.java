 ...
 */
public class FeishuPresenter extends AbstractPresenter implements RimetContract.Presenter {

    private IRimetSource mRimetSource;
    private RimetContract.View mView;
    private XVersionManager mVersionManager;

    public FeishuPresenter(XPluginManager xPluginManager, RimetContract.View view) {
